              ...
              <div className="hover-popup">
                ...
                <div className="p-4 bg-primeHover">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <button className="w-11 h-11 rounded-full border-2 border-gray-500 flex items-center justify-center text-white hover:border-white transition-colors bg-white/5">
